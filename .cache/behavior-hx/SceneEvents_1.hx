...
class SceneEvents_1 extends SceneScript
{
	...
	override public function init()
	{
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			...
			{
				getActor(14).disableActorDrawing();
				getActor(11).setX(getActor(1).getX());
				getActor(11).setY((getActor(1).getY() - 50));
				...
				if(((Engine.engine.getGameAttribute("potatoPicked") : Bool) == true))
				{
					getActor(12).enableActorDrawing();
				}
			}
		...
		/* ========================= Type & Type ========================== */
		addSceneCollisionListener(getActorType(0).ID, getActorType(102).ID, function(event:Collision, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
